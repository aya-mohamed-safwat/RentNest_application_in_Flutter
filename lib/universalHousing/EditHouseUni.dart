...
void getHouseToUpdateUni(Map<dynamic , dynamic> getData){
  dataUni =getData ;
}

String bathroom =dataUni['bathroomsNum'].toString();
String bedroom =dataUni['bedroomsNum'].toString();
String location =dataUni['location'].toString();
int houseId =dataUni['universalHouseId'];


class EditHouseUni extends StatefulWidget {
  @override
  _EditHouseUniState createState() => _EditHouseUniState();
}

class _EditHouseUniState extends State<EditHouseUni> {
  ...
  void initState() {
    ...
    super.initState();
    _size.text = dataUni['size'].toString();
    _price.text = dataUni['price'].toString();
    _description.text = dataUni['description'].toString();
    selectedLocation = dataUni['location'].toString();
    bedRoom = int.parse(dataUni['bedroomsNum'].toString());
    bathRoom = int.parse(dataUni['bathroomsNum'].toString());
    _lights =bool.parse(dataUni['availability'].toString());
  }
  ...
  void editItem(String? location , double size , double price ,int bathRoom
    ...
    try {
      final response = await http.put(
        Uri.parse('https://rentnestapi.onrender.com/rentNest/api/updateUniversalHouse/$houseId'),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: PageView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                return AnimatedBuilder(
                  ...
                  child: Container(
                    ...
                    child: Image.network(ImagesForEditingUni[index],
                      fit: BoxFit.fitWidth,
              ...
              itemCount: ImagesForEditingUni.length,
            ),
          ),
          const SizedBox(
            height: 20.0,
