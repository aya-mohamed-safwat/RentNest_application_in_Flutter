...
class editprofileUni extends StatefulWidget {
  @override
  State<editprofileUni> createState() => _ProfileState();
}

class _ProfileState extends State<editprofileUni> {
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: [
                        ...
                        CircleAvatar(
                          radius: 64,
                          backgroundImage: imageBytesUni.isEmpty
